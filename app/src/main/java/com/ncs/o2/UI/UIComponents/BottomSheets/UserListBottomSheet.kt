...
class UserListBottomSheet(
    ...
    private fun setRecyclerView(userList: MutableList<User>) {
        adapter = AssigneeListAdpater(userList, this)
    ...
    override fun onAssigneeClick(contributor: User, position: Int, isChecked: Boolean) {
        ...
        callbacks.sendassignee(contributor,isChecked,position,type)
    ...
    interface getassigneesCallback {
        ...
        fun sendassignee(assignee:User,isChecked: Boolean,position: Int,type: String)
