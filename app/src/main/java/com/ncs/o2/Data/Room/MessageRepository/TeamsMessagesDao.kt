...
interface TeamsMessagesDao {
    ...
    @Query("SELECT message_table.* FROM message_table " +
            ...
            "WHERE message_project_table.projectId = :projectId AND message_project_table.channelId = :channelId")
    fun getMessagesForProject(projectId: String,channelId:String): List<Message>
